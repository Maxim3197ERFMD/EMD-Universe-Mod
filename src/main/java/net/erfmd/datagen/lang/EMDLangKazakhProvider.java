...
public class EMDLangKazakhProvider extends FabricLanguageProvider {
    public EMDLangKazakhProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
        super(dataOutput, "kk-kz", registryLookup);
    }
